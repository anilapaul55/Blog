                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('index')}}">Blogs</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('create')}}">Add New Blog</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body p-5">
                    ...
                    <form class="row g-3" action="{{route('store')}}" method="post" id="blog_form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="name"  class="form-control brand_blur  @error('inputTitle') is-invalid @enderror" id="inputTitle" value="{{old('inputTitle')}}" name="inputTitle">
                            @error('inputTitle')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="code"  class="form-control brand_blur @error('inputSubTitle') is-invalid @enderror" id="inputSubTitle" value="{{old('inputSubTitle')}}" name="inputSubTitle">
                            @error('inputSubTitle')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control demoInputBox @error('inputimage') is-invalid @enderror" type="file" id="inputimage" name="inputimage"    value="{{old('inputimage')}}">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control brand_blur @error('inputDescription') is-invalid @enderror" id="inputDescription" name="inputDescription" placeholder="description..." rows="3">{{old('inputDescription')}}</textarea>
